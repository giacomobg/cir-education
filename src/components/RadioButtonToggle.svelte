...
input[type="radio"]:not(:checked)+label:not(:disabled):hover {
	opacity: 75%;
}

input[type="radio"]:not(:checked)+label:not(:disabled):active {
	opacity: 50%;
}
...
input[type="radio"]:checked+label {
    ...
    color: white;
    /* background-color: #d82d1d1A; */
}
input[type="radio"]:focus+label {
	border: 2px solid #D82D1D;
    margin: 0;
}
